...
build() {
	...
	# note: not autotools
	LDFLAGS="$LDFLAGS -Wl,--strip-debug -Wl,-soname,libc.musl-$CARCH.so.1" \
	./configure \
		--build=$CBUILD \
		--host=$CHOST \
		--prefix=/usr \
...
fcb7d9edcca31fe17f88b9e7d2716c54f0e4d29e5b23ac90b10614e5409688c12d54fc2ccd4efd35bf2c0829f9a72802f3f551f06bb5cf6ca61426465005742b  gcc-compatability.patch
